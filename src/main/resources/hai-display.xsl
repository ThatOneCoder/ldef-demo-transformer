...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n1="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <!--                                               KH / Dec 30 2008
     This is derived directly from the AALLC November 2008 CDA 
  ...
  <xsl:template match="n1:ClinicalDocument">
    <html>
      <xsl:comment>
          ...
          The stylesheet which produced this display of the CDA document was most recently updated by AALLC, 
          on December 30, 2008. 
          The stylesheet is the cumulative work of several developers; the most significant prior milestones 
          were the foundation work from HL7 Finland (Tyylitiedosto) and HL7 US (Calvin Beebe), 
      ...
      <body>
        ...
        <xsl:if test="not(/n1:ClinicalDocument/n1:templateId[@root='2.16.840.1.113883.10.20.5.15'])">
